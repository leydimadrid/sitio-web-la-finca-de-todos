...
export const InfografiaPasaDia = () => {
  return (
    <section className="fondoInfografiaPasaDia  md:bg-cover bg-cover">
      ...
      <div>
        <h1 className="font-bold md:text-6xl text-3xl text-center md:pt-24 text-pink-600" tabIndex={0}>
          Pasadía para niños
        </h1>
        <h1 className="block font-bold md:text-6xl text-3xl text-center text-pink-600" tabIndex={0}>
      ...
      <div className="flex justify-center px-4 ">
        <p className="text-gray-800 font-normal lg:text-xl text-sm max-w-4xl text-justify leading-relaxed" tabIndex={0}>
          Un pequeño encuentro con el descanso y la diversión.
        </p>
      </div>
      {/* Final párrafo introductorio */}
      {/* Línea */}
      <hr className="linea-azul h-1 max-w-xl md:mx-auto mx-auto mt-2" tabIndex={0}></hr>
      {/* Línea */}
      ...
      <section className="flex md:flex-row lg:flex-row flex-col justify-start md:mt-24 lg:mt-24 mt-10">
        <div className="basis-2/5 w-auto grid place-items-center">
          <h1 className="FondoFucsiaInfografia py-2 md:text-2xl text-xl font-bold text-white rounded-xl text-center w-72 px-3 md:mx-0 mx-auto mb-4" tabIndex={0}>
            INICIO
          </h1>
          <p className="md:text-xl lg:text-lg text-base text-gray-800 leading-relaxed" tabIndex={0}>
            Llegada a{" "}
            <span className="text-blue-900 font-semibold">
              La Finca de Todos{" "}
            </span>
          </p>
          <img src={logo} alt="Logo La Finca De Todos" className="mt-2" tabIndex={0} />
        </div>
      ...
      <hr className="linea-discontinua w-full md:w-3/4 lg:w-3/4 mt-2" tabIndex={0}></hr>
        ...
        <div className="basis-2/5 grid place-items-center">
          <div className="w-auto grid place-content-start">
            <div className="grid place-content-center">
              <img src={tiempoActividades} alt="Vector de un reloj" tabIndex={0}/>
              <h1 className="md:text-xl lg:text-lg text-base text-gray-800 font-semibold" tabIndex={0}>
                15 MIN
              </h1>
            </div>
            <h1 className="FondoFucsiaInfografia py-2 md:text-2xl text-xl font-bold text-white rounded-xl text-center px-3 md:mx-0 mx-auto mb-4 mt-4" tabIndex={0}>
              CENTRO DE BIENVENIDA
            </h1>
            <div>
              <ul className="font-normal md:text-xl lg:text-lg text-base text-gray-800 leading-relaxed md:text-right lg:text-right text-center" tabIndex={0}>
      ...
      <section className="flex md:flex-row lg:flex-row flex-col justify-start md:mt-24 lg:mt-24 mt-10">
        <div className="basis-2/5 grid place-items-center">
          <div className="w-auto grid place-content-start">
            ...
            <h1 className="bg-blue-900 py-2 md:text-2xl text-xl font-bold text-white rounded-xl text-center px-3 md:mx-0 mx-auto mb-4 mt-4" tabIndex={0}>
              EN EL HUERTO
            </h1>
            <div>
              <ul className="font-normal md:text-xl lg:text-lg text-base text-gray-800 leading-relaxed md:text-left lg:text-left text-center" tabIndex={0}>
                <li className="leading-relaxed">
                  {" "}
        ...
        <div className="basis-2/5 grid place-items-center">
          <div className="w-auto grid place-content-start">
            ...
            <div className="max-w-md">
              <p className="font-normal md:text-xl lg:text-lg text-base text-gray-800 leading-relaxed md:text-right lg:text-right text-center" tabIndex={0}>
                {" "}
