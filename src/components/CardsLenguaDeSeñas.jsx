  ...
  return (
    <section className="flex justify-center mt-4">
      ...
      <div className="fondoCardsActividades  items-center leading-normal text-center rounded-lg md:p-10 p-5">
        <h5 className="mb-4 md:text-xl text-base font-bold tracking-tight text-gray-800">
          Hora de cuentos en Lengua de Señas Colombiano
        </h5>
        <div className="flex justify-center">
          <p className="mb-2 md:text-xl text-sm tracking-tight text-gray-800 max-w-3xl text-justify pb-4">
