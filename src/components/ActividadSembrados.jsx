...
import imagen1 from '../assets/images/actividades-sembrados.webp';
import imagen2 from '../assets/images/actividades-sembrados-2.webp';
					...
					>
						<div className='items-center p-4 leading-normal md:w-96 w-64 text-center'>
							<p
								...
								tabIndex={0}
							>
								{t('weekend.paragraphCards-2')}
							</p>
						</div>
						<img
							className='lg:w-96 w-64 lg:rounded-r-lg rounded-b-lg'
							src={imagen2}
							alt={t('activities.card-2-img-2')}
							tabIndex={0}
						/>
					</button>
				</div>
