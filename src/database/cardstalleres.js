export const cardstalleres = [
	{
		id: 1,
		imagen: 'talleres-el-campo.jpg',
		titulo: 'El campo',
		parrafo:
			'Aprendamos cómo llegan a nuestra mesa los productos que crecen en el campo y apreciemos el trabajo de nuestros campesinos.',
		alt: 'Niña sonriendo en el campo, con tomates en su mano',
	},
	{
		id: 2,
		imagen: 'talleres-reciclaje.jpg',
		titulo: 'Reciclaje',
		parrafo:
...

	{
		...
		parrafo:
			'Conozcamos más sobre las contribuciones de las tribus indígenas y los pueblos afrocolombianos en el desarrollo de nuestra patria multicultural.',
	...
	{
		id: 5,
		imagen: 'talleres-meditacion-y-yoga.jpg',
...

	{
		...
		parrafo:
			'Con una variedad de actividades en equipo y logros individuales, mucha diversión te espera en La Finca de Todos. El énfasis está en la amistad, no en el puntaje final y siempre está la opción de tomar un descanso para los que prefieren apoyar y no participar.',
